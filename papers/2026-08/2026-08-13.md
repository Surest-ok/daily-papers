...
### 1. **[What Actually Serializes GPU LZ77 Decode: Three Decoders, Three Mechanisms, and an Encode-Time Lever That Removes the Last One](https://arxiv.org/abs/2608.10188v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-10
- **作者**: Yakiv Shavidze
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: 优化GPU LZ77解码并行度与内存访问
<details>
...
- **评分理由**: 深入剖析解码瓶颈并提出工程优化，实测数据详实。

### 2. **[FaCTz: Fast Critical-Point and Topology-Aware GPU Compression for Scientific Vector Fields](https://arxiv.org/abs/2608.10586v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-11
- **作者**: Mingze Xia, Yuxiao Li, Sheng Di et al.
- **标签**: `cs.DC`
- **AI摘要**: 首个GPU加速的拓扑感知矢量场压缩系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了GPU并行化拓扑保持压缩，性能提升显著且具备工程实用性。

## Cloud Native Infrastructure

### 1. **[ClusterBench: A Framework for Cluster-Wide Continuous Benchmarking and Regression Testing](https://arxiv.org/abs/2608.10956v1)**
...
- **评分理由**: 针对数据中心性能回归的实用工具，实测数据详实。

## Network Stack & Protocol

### 1. **[Media-over-Multipath-QUIC for Realtime Video Applications](https://arxiv.org/abs/2608.10741v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-11
- **作者**: Tanya Shreedhar, Zuji Zhou, Nitinder Mohan et al.
- **标签**: `cs.NI` `cs.ET` `cs.MM`
- **AI摘要**: 基于MoQT元数据的多路径QUIC调度优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过语义感知调度显著降低视频延迟，工程落地性强

### 2. **[Laser-Diode LiFi With Diffused-Beam Optics: System-Level Modeling and a Cross-Validated ns-3 Simulation Framework](https://arxiv.org/abs/2608.10950v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-11
- **作者**: Hussain Ahmad, Syed Muhammad Talha Gillani, Toheed Omer et al.
- **标签**: `eess.SP` `cs.NI`
- **AI摘要**: 提出激光LiFi系统建模与ns-3仿真框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 硬件原型与仿真结合紧密，评估严谨且开源，实用性较强。

## Middleware & Runtime

### 1. **[Hand-Written PTX Tensor-Core GEMM Kernels: A Multi-Precision Study on NVIDIA L4](https://arxiv.org/abs/2608.10103v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Matt J. Borowski, Blazej Osinski
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 手写PTX优化NVIDIA Tensor Core GEMM性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对底层算子优化，实测数据详实，具有工程参考价值

### 2. **[Machine Shape and Hierarchical Blocking: A Mathematics of Arrays Formalization, with an Open Problem in Hierarchical Shape Occupancy](https://arxiv.org/abs/2608.10119v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Lenore M Mullin
- **标签**: `cs.PF`
- **AI摘要**: 基于MoA框架的层级缓存分块调度优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过数学建模优化缓存分块，具备实机验证与工程价值。

### 3. **[Performance and Cost-Aware Cache Provisioning](https://arxiv.org/abs/2608.09820v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Ridwanul Tanvir, George Kesidis
- **标签**: `cs.PF`
- **AI摘要**: 提出一种基于SLO的缓存容量与性能动态优化策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对实际生产环境的缓存资源优化，具有较强实用性

### 4. **[A Preliminary Study on Simultaneous Coscheduling for Discrete GPU vs. Fused GPU](https://arxiv.org/abs/2608.09647v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-10
- **作者**: Poorna Gunathilaka, Nabayan Chaudhury, Kirshanthan Sundararajah et al.
- **标签**: `cs.DC`
- **AI摘要**: 对比GH200与H100的CPU-GPU协同调度性能
<details>
<summary>原始摘要</summary>
