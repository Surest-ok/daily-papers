...
### 1. **[Themis: Software-Defined Hardware Prefetching](https://arxiv.org/abs/2608.00259v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-31
- **作者**: Keisuke Kamahori, Neil Adit, Kan Zhu et al.
- **标签**: `cs.AR` `cs.OS`
- **AI摘要**: 通过页表提示优化硬件预取以减少内存带宽浪费
<details>
...
- **评分理由**: 提出软硬协同预取机制，在实际负载中验证了有效性

## File Systems & Storage

### 1. **[Themis: A Filesystem Model Checker That Owns the Machine](https://arxiv.org/abs/2608.01135v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-08-02
- **作者**: Daeyeon Son
- **标签**: `cs.OS` `cs.SE`
- **AI摘要**: 基于Hypervisor的底层文件系统模型检查器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用虚拟化技术实现高效状态快照与时间控制，验证严谨且实用。

### 2. **[Error-bounded Point Cloud Compression Using Truncated Octahedron Quantization](https://arxiv.org/abs/2608.00495v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-01
- **作者**: Youyuan Liu, Longtao Zhang, Ruoyu Li et al.
- **标签**: `cs.PF` `cs.DB` `cs.DC`
- **AI摘要**: 基于截断八面体量化的点云压缩系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对科学数据存储的压缩优化，工程实现完整且性能提升显著。

### 3. **[Lossless Compression Performance for PETRA III Datasets](https://arxiv.org/abs/2608.00168v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-31
- **作者**: Malte Buschmann, Yannis Schumann, Christian Voss et al.
- **标签**: `physics.data-an` `cs.PF` `physics.ins-det`
- **AI摘要**: 评估PETRA III数据集的无损压缩性能与策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于真实大规模科研数据的系统存储优化评估，实用性强

## Cloud Native Infrastructure

### 1. **[Source-Bounded Exact Recovery over Docker's Logs API](https://arxiv.org/abs/2608.01564v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-03
- **作者**: Kelvin Amoaba
- **标签**: `cs.DC` `cs.OS` `cs.SE`
- **AI摘要**: 提出LogDeck解决容器日志丢失与重复问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对Docker日志API的工程改进，实验严谨且具备生产价值

### 2. **[Cache-Consistent Dynamic Load Balancing for Kubernetes Controllers](https://arxiv.org/abs/2608.00454v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-01
- **作者**: Shoma Ansai, Yasuo Okabe, Daisuke Kotani
- **标签**: `cs.DC`
- **AI摘要**: 提出一种基于一致性哈希的K8s控制器水平扩展方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了控制器水平扩展中的状态同步与缓存一致性问题，工程实用性强

## Network Stack & Protocol

### 1. **[HCCL: Collective Communication for Meta Training and Inference Accelerators](https://arxiv.org/abs/2608.00358v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-01
- **作者**: Wesley Bland, Tiago Antunes, Lars Paul Huse et al.
- **标签**: `cs.NI` `cs.DC`
- **AI摘要**: Meta MTIA 300专用通信库HCCL
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 硬件协同设计，生产环境部署，性能指标优异

### 2. **[TurboRetry: Mitigating Large-Scale QUIC Handshake Floods with Off-the-Shelf DPU Offloading](https://arxiv.org/abs/2608.02264v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-03
- **作者**: Jiahao Wu, Heng Pan, Kai Lv et al.
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 利用DPU卸载QUIC重试机制以防御握手洪水攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对QUIC协议的工程化优化，实测性能提升显著，具备生产落地价值。

### 3. **[Shiftfly: Scaling the Accelerator Interconnect Past the Pod with a Shift-Routed Optical Tier](https://arxiv.org/abs/2608.00897v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-01
- **作者**: Eylon E. Krause
- **标签**: `cs.NI` `cs.DC`
- **AI摘要**: 基于Kautz图的超大规模加速器互联架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对超大规模集群的互联优化，工程实现可行性高

### 4. **[When Discovery Becomes a Storm: A ROS 2 Discovery Model for Wireless Robotic Networks](https://arxiv.org/abs/2608.02242v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-03
- **作者**: Yeonwoo Choi, Sanghoon Lee, Kyung-Joon Park
- **标签**: `cs.NI`
- **AI摘要**: 提出ROS 2闭环发现模型以缓解无线网络风暴
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型严谨且实验充分，提出的优化策略具备工程落地价值

### 5. **[NoisePQC++: A Unified NIST-Compliant PQC and Hybrid-PQC Implementation of the Noise Protocol](https://arxiv.org/abs/2608.00954v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-02
- **作者**: Nadeem Ahmed, Aryya Gangopadhyay, Lei Zhang
- **标签**: `cs.CR` `cs.NI` `quant-ph`
- **AI摘要**: 实现支持NIST标准的后量子Noise协议框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程实现完整且具备实际部署价值，性能评估扎实

## Middleware & Runtime

### 1. **[Epico: Long-Lived WebAssembly Components for High-Performance Serverless Stream Processing](https://arxiv.org/abs/2608.02361v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-03
- **作者**: Matteo Della Bartola, Valerio Besozzi, Patrizio Dazzi et al.
- **标签**: `cs.DC`
- **AI摘要**: 基于Wasm的流处理运行时，优化冷启动与吞吐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计实用，通过AOT与直连通信显著提升性能

### 2. **[Fast Discovery of Inclusion Dependencies with Desbordante](https://arxiv.org/abs/2608.02213v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-03
- **作者**: Alexander Smirnov, Anton Chizhov, Ilya Shchuckin et al.
- **标签**: `cs.DB` `cs.AI` `cs.DC`
- **AI摘要**: 通过SIMD与并行化优化数据依赖发现算法性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程优化显著提升了数据分析工具的执行效率

### 3. **[A Portable and Versatile Limited-Memory BFGS Implementation in PETSc/TAO](https://arxiv.org/abs/2608.00196v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-31
- **作者**: Hansol Suh, Tobin Isaac, Alp Dener et al.
- **标签**: `cs.DC`
- **AI摘要**: PETSc/TAO中L-BFGS算法的性能优化实现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在高性能计算框架中实现了更高效的L-BFGS变体，并在真实超级计算机上进行了基准测试。

### 4. **[A Unified Benchmark for Privacy-preserving Vector Search](https://arxiv.org/abs/2608.01192v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-02
- **作者**: Anne-Marie Kermarrec, Rafael Pires, Mathis Randl et al.
- **标签**: `cs.CR` `cs.DB` `cs.PF`
- **AI摘要**: 建立隐私向量搜索的统一基准评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实测对比多种加密方案，为生产部署提供决策依据

### 5. **[Less Is More: Tuning Configurable Systems with Imperfect Fidelity](https://arxiv.org/abs/2608.00759v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-01
- **作者**: Yulong Ye, Miqing Li, Tao Chen
- **标签**: `cs.SE` `cs.AI` `cs.DB`
- **AI摘要**: 利用低保真环境优化系统配置调优效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多保真度探索提升配置调优效率，实验详实且具有工程实用价值。

## Distributed Systems

### 1. **[Diagnosing High-Performance BFT Consensus via Mixture Modeling of Block Time Distributions](https://arxiv.org/abs/2608.01934v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-03
- **作者**: Hongru He, Akihiro Fujihara
- **标签**: `cs.DC` `cs.CE` `cs.CR`
- **AI摘要**: 利用混合模型诊断BFT共识延迟分布
<details>
<summary>原始摘要</summary>
