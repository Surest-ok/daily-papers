...
### 1. **[Vulnerabilities, Secrets and Misconfiguration in the Highest-Exposure Docker Hub Images](https://arxiv.org/abs/2608.02669v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-02
- **作者**: Cristhian Kapelinski, Beatriz Machado, Diego Kreutz
- **标签**: `cs.CR` `cs.AI` `cs.CY`
- **AI摘要**: 大规模Docker镜像漏洞与配置审计分析
<details>
...
- **评分理由**: 通过大规模实测揭示了镜像生态的漏洞分布与工具偏差，具有极高的工程参考价值。

## Network Stack & Protocol

### 1. **[VeraRAN: Pre-Actuation Certification and Event-Causal Synchronization Repair for Asynchronous Multi-Interface RAN Plans](https://arxiv.org/abs/2608.01047v2)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-02
- **作者**: Yinghan Hou, Zongyou Yang
- **标签**: `cs.NI`
- **AI摘要**: VeraRAN通过因果同步修复RAN异步执行安全问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对无线接入网控制器的异步执行安全问题，提出了实用的验证与修复机制，评估扎实。

### 2. **[Domain Decoupling Attack: Exploiting the Validation Gap Between Protective DNS and Shared Edge Routing](https://arxiv.org/abs/2608.00643v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-01
- **作者**: Weizhe Wang, Minhong Dong, Jinhao Li et al.
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 揭示DNS授权漏洞导致的跨租户共享IP绕过攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模实测揭示了CDN与共享托管环境的DNS验证缺陷，具有极高的工程安全价值。

### 3. **[Real-time decoding of quantum error correction codes using high-performance computing](https://arxiv.org/abs/2608.03948v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-04
- **作者**: Lingling Lao, Qiang Wang, Yuanqi Liu et al.
- **标签**: `quant-ph` `cs.DC`
- **AI摘要**: 提出THQLink架构实现量子纠错实时解码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统架构设计扎实，在真实硬件上实现了低延迟解码。

### 4. **[Emulation vs Simulation: A Case Study from Congestion Control Algorithms in Low Earth Orbit Satellite Networks](https://arxiv.org/abs/2608.02095v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-03
- **作者**: Aiden Valentine, Mihai Mazilu, James Knowles et al.
- **标签**: `cs.NI`
- **AI摘要**: 对比仿真与模拟在LEO卫星网络拥塞控制中的评估差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实测与仿真对比，为网络协议评估方法论提供实践指导

### 5. **[LightCal: Lightweight Optical-Pulse Bootstrap Calibration for Crystal-Free BLE Radios](https://arxiv.org/abs/2608.00141v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-31
- **作者**: Cheng Wang, Titan Yuan, David Burnett et al.
- **标签**: `cs.NI`
- **AI摘要**: 利用光脉冲校准无晶振BLE射频频率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决无晶振IoT引导校准问题，实验扎实

## Middleware & Runtime

### 1. **[Resume Means Resume: A Machine-Checked Conformance Contract for Checkpoint, Interrupt, and Resume Semantics in Workflow Persistence Layers](https://arxiv.org/abs/2608.03836v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Sajjad Khan
- **标签**: `cs.LG` `cs.DC` `cs.LO`
- **AI摘要**: 提出工作流持久化一致性契约与REMIT验证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化验证解决了工作流恢复语义不一致问题，工程实用性强。

### 2. **[Certified Split Points for Parallel Lexing: Exact and Modulo Discarded Tokens](https://arxiv.org/abs/2608.03473v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Nicklas Nidhögg
- **标签**: `cs.FL` `cs.DC` `cs.PL`
- **AI摘要**: 提出一种基于确定性分割点的并行词法分析方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过静态分析实现无需推测的并行词法分析，性能提升显著

### 3. **[DEFT: Joint Task Placement and DVFS for Energy-Efficient Multi-GPU Runtimes](https://arxiv.org/abs/2608.02122v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-03
- **作者**: Jing Chen, Miquel Pericas
- **标签**: `cs.DC`
- **AI摘要**: DEFT通过联合调度与DVFS优化多GPU能效
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统级调度优化，原型实现且有真实硬件评估

### 4. **[NotDec: WebAssembly Decompilation With Inter-Procedural Type Recovery](https://arxiv.org/abs/2608.03286v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Jikai Wang, Ningyu He, Tianming Liu et al.
- **标签**: `cs.SE`
- **AI摘要**: 一种高效的WebAssembly反编译与类型恢复框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在WASM逆向工程领域有显著改进，评估严谨且实用性强

### 5. **[CUDA MPC: A GPU-Native Solver for Model Predictive Control](https://arxiv.org/abs/2608.03051v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-04
- **作者**: Babak Akbari, Melissa Greeff
- **标签**: `cs.RO` `cs.DC` `eess.SY`
- **AI摘要**: 一种基于GPU内核融合的实时MPC求解器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过内核融合与内存优化显著提升了MPC求解效率

## Distributed Systems

### 1. **[Configurable and Hierarchical Allreduce](https://arxiv.org/abs/2608.02884v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-03
- **作者**: Valentino Guerrini, Ke Fan, Sidharth Kumar
- **标签**: `cs.DC`
- **AI摘要**: 一种针对MPI通信的层级化Allreduce优化方案
<details>
<summary>原始摘要</summary>
