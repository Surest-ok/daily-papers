...
### 1. **[Effects of Hybrid CPU and Cache Architectures on Parallel HPC and Cloud Applications](https://arxiv.org/abs/2608.23165v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-24
- **作者**: Nanda Velugoti, Joseph Manzano, Nathan Tallent et al.
- **标签**: `cs.DC`
- **AI摘要**: 分析混合架构CPU对HPC并行任务的性能影响
<details>
...
- **评分理由**: 对混合架构下的线程调度与缓存行为进行了实测分析，具有工程参考价值。

## File Systems & Storage

### 1. **[SxSSD: A Secure and Extensible Software-defined Solid State Drive](https://arxiv.org/abs/2608.23365v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Josh Dafoe, Bo Chen
- **标签**: `cs.CR` `cs.OS`
- **AI摘要**: SxSSD实现安全且可扩展的软件定义SSD架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出软硬解耦的FTL策略，原型系统评估详实，实用性强

## Cloud Native Infrastructure

### 1. **[Fleet-Scale Pod Deployment with VPC-Native Networking in Managed Kubernetes](https://arxiv.org/abs/2608.22210v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-23
- **作者**: Sri Saran Balaji Vellore Rajakumar, Jayanth Varavani, Murat Parlakisik et al.
- **标签**: `cs.NI` `cs.DC`
- **AI摘要**: 对比分析EKS VPC原生网络模式的部署性能与扩展性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于真实大规模集群的性能评估，对生产环境选型极具参考价值。

## Network Stack & Protocol

### 1. **[Building A CSFQ-Inspired Transport for Switched CXL Memory Pooling](https://arxiv.org/abs/2608.21731v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-22
- **作者**: Zerui Guo, Emily Shriver, Ming Liu
- **标签**: `cs.NI`
- **AI摘要**: 提出MemChannel传输协议以优化CXL内存池带宽分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对CXL交换式内存池的拥塞控制，实测效果显著且架构清晰

### 2. **[Age-Optimal Target Wake Time: Provably Good Wake Schedules for Energy-Constrained Wi-Fi Status Updating](https://arxiv.org/abs/2608.21596v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-21
- **作者**: Haoyu Wang, Bo Sheng, Xiaoqian Zhang
- **标签**: `cs.NI` `cs.IT`
- **AI摘要**: 提出基于TWT的AoI优化调度算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法严谨且有ns-3实现，但缺乏真实硬件部署数据

## Middleware & Runtime

### 1. **[mold: A Massively Parallel Linker](https://arxiv.org/abs/2608.23228v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-08-24
- **作者**: Rui Ueyama
- **标签**: `cs.OS`
- **AI摘要**: 一种利用数据并行技术大幅提升链接速度的高性能链接器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程实现极佳，解决了大型软件构建的性能瓶颈，实用性极高

### 2. **[Exploring spectral element methods on the Tenstorrent RISC-V accelerator](https://arxiv.org/abs/2608.22964v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-24
- **作者**: Daniyal Arshad, Nick Brown
- **标签**: `cs.DC`
- **AI摘要**: 在Tenstorrent加速器上优化Nekbone算子性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对特定硬件架构的算子移植与优化，评估扎实且具有实用价值。

### 3. **[Composable Building Blocks for Resilient Asynchronous Code](https://arxiv.org/abs/2608.21489v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Frank Tip
- **标签**: `cs.SE` `cs.PL`
- **AI摘要**: 提出异步代码组合子以增强系统韧性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过高阶组合子统一异步逻辑，工程实用性强

### 4. **[A Concurrent Queue System for Multi-GPU Platforms: Application to Bellman-Ford SSSP](https://arxiv.org/abs/2608.21826v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-08-22
- **作者**: Beyza Cavusoglu
- **标签**: `cs.DC`
- **AI摘要**: 基于NVSHMEM的多GPU并发队列系统设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了多GPU环境下的高效队列，并在实际硬件上进行了性能评估。

## Distributed Systems

### 1. **[Scalable Exact Path Selection via Structure-Aware Search for Virtual Payment Channels](https://arxiv.org/abs/2608.22276v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-23
- **作者**: Jiangnan Luo, Zhebei Shen, Yuan Zhang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出基于四叉树搜索的虚拟支付通道路径选择算法
<details>
<summary>原始摘要</summary>
