...
### 1. **[SPIDER4TianoCore: Enhancing Patch-Propagation for the TianoCore UEFI Firmware Development Ecosystem](https://arxiv.org/abs/2608.23755v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-24
- **作者**: Laura Baird, Devin Haggitt, Terrance E. Boult et al.
- **标签**: `cs.SE`
- **AI摘要**: 用于UEFI固件补丁传播的自动化验证工具
<details>
...
- **评分理由**: 针对固件供应链的实用工具，评估严谨但适用范围较窄。

## Cloud Native Infrastructure

### 1. **[A Capability Broker for Workflow-Network QoS Coordination in B5G/6G Industrial Services](https://arxiv.org/abs/2608.24496v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-25
- **作者**: Qize Guo, Yan Chen, Taleb Tarik et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出一种B5G/6G工业服务QoS协调代理机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计清晰，原型评估扎实，符合工业网络控制平面需求。

## eBPF & Observability

### 1. **[Effective Pivot Attack Detection via System and Network Information](https://arxiv.org/abs/2608.23731v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Ava Powelson, Carson Kuzniar, Hyojoon Kim et al.
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 基于eBPF的实时主机侧枢纽攻击检测系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用内核可编程性关联系统与网络信息，评估扎实且具备生产部署价值。

## Network Stack & Protocol

### 1. **[ECO-COMM: An Ultra Low-Latency Event Camera based Optical Communication System](https://arxiv.org/abs/2608.24705v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-25
- **作者**: Chengling Xu, Keigo Hirakawa, Feng Ye
- **标签**: `cs.NI`
- **AI摘要**: 基于事件相机的超低延迟光通信系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用事件相机实现微秒级通信，原型验证充分且实用性强。

### 2. **[BotScan: An adaptive active probing approach for identifying live IoT Botnet C2 servers at scale](https://arxiv.org/abs/2608.23854v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-24
- **作者**: S M Maksudul Alam, Vivek Jain, Zhaowei Tan et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出BotScan主动探测技术以高效识别IoT僵尸网络C2服务器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对IoT僵尸网络提出自适应探测策略，实测效果显著，工程实用性强。

## Middleware & Runtime

### 1. **[pigzpp: Fast, Parallel, Portable Compression for the Whole Stack](https://arxiv.org/abs/2608.24153v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-25
- **作者**: Thamme Gowda
- **标签**: `cs.DC`
- **AI摘要**: 高性能并行压缩库重构与多语言支持
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程实现扎实，性能提升显著，具备高生产实用性。

### 2. **[vToken: Token-Level Virtualization for Reclaimable KV Caches](https://arxiv.org/abs/2608.13263v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Yuanhang Gao, Xiangrui Yang, Yuanfeng Chen et al.
- **标签**: `cs.AI` `cs.DC` `cs.OS`
- **AI摘要**: vToken：LLM KV缓存的内存虚拟化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性高，实用性强，评估严谨，清晰易懂。

### 3. **[The Ingestion Tax: Adopting File-Backed Weights in Tensor Frameworks](https://arxiv.org/abs/2608.12114v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-12
- **作者**: Yuan Si, Yufeng Lin, Daming Li et al.
- **标签**: `cs.OS`
- **AI摘要**: 文件后备权重，消除AI推理的内存开销
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性高，实用性强，评估严谨，表述清晰，符合系统研究方向。

## Distributed Systems

### 1. **[Scalable datacenter replication with mostly-synchronous consensus on hardware](https://arxiv.org/abs/2608.24622v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-25
- **作者**: Davide Rovelli, Philipp Berdesinski, Rodrigo Otoni et al.
- **标签**: `cs.DC`
- **AI摘要**: 基于FPGA智能网卡的高性能共识协议实现
<details>
<summary>原始摘要</summary>
