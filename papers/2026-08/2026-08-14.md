...
### 1. **[Who Should Own the Expert Cache? Kernel-Managed Tiering for Trillion-Parameter MoE Inference](https://arxiv.org/abs/2608.12103v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-12
- **作者**: Yuan Si, Yufeng Lin, Daming Li et al.
- **标签**: `cs.OS`
- **AI摘要**: 利用内核页缓存优化超大规模MoE模型推理内存管理
<details>
...
- **评分理由**: 通过实测证明内核LRU在MoE缓存管理中优于用户态方案

### 2. **[Velosiraptor: Code Synthesis for Memory Translation](https://arxiv.org/abs/2608.07966v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-08
- **作者**: Reto Achermann, Em Chu, Ryan Mehri et al.
- **标签**: `cs.OS` `cs.CR` `cs.PL`
- **AI摘要**: 自动生成内存管理硬件配置的OS代码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化方法解决OS内存配置难题，工程实用性较强

## Cloud Native Infrastructure

### 1. **[An Event-Driven Cloud-Native Wearable Analytics Framework for Real-Time Clinical Workloads](https://arxiv.org/abs/2608.11402v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-11
- **作者**: Elias Grünewald, Daniil Cherepko, Linus Gustafsson et al.
- **标签**: `cs.DC`
- **AI摘要**: 一种云原生可穿戴设备实时临床数据分析框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计实用且具备生产部署潜力，性能评估扎实。

## Network Stack & Protocol

### 1. **[Association-based Privacy Attacks in Wireless Protocols: Formal Modeling and Mitigation](https://arxiv.org/abs/2608.11337v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-11
- **作者**: Mohit Kumar Jangid, Felix Engelmann, Zhiqiang Lin
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 提出无线协议隐私攻击建模与防御方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化建模识别协议漏洞并获行业采纳，实用性强。

## Middleware & Runtime

### 1. **[Enabling Differentiated QoS Degradation for Replicated Databases under Failures](https://arxiv.org/abs/2608.11836v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-12
- **作者**: Belkis Djeffal, Pierre Bourhis, Romain Rouvoy
- **标签**: `cs.DB` `cs.DC`
- **AI摘要**: 基于JDBC中间件的数据库QoS降级策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统实现完整且在真实数据库场景下进行了有效评估

### 2. **[Testing the EPYC Conjecture on Real Hardware: MoA-Guided Dense Matrix Multiplication on NCSA Delta (AMD EPYC 7763 Milan)](https://arxiv.org/abs/2608.11533v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-12
- **作者**: Lenore M Mullin
- **标签**: `cs.PF`
- **AI摘要**: 基于缓存形状优化的矩阵乘法性能提升
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过硬件缓存特性优化矩阵乘法，实测性能显著提升

### 3. **[MergirafSemi: A Language-Agnostic Semistructured Merge Tool](https://arxiv.org/abs/2608.11345v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-11
- **作者**: Pedro Lopes, Paulo Borba, Paola Accioly et al.
- **标签**: `cs.SE`
- **AI摘要**: 一种语言无关的半结构化代码合并工具
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过轻量级语法树优化合并冲突，工程实用性强

### 4. **[Evaluating OpenMP Offloading for Intra-node Multi-GPU Programming across NVIDIA, AMD, and Intel Architectures: A 3D Heat Transfer Case Study](https://arxiv.org/abs/2608.11882v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-12
- **作者**: Ezhilmathi Krishnasamy
- **标签**: `cs.DC`
- **AI摘要**: 评估OpenMP在多GPU架构下的性能表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实测对比OpenMP与原生模型，对高性能计算有参考价值
