...
### 1. **[A Measurement Study of AI-Environment Realism Gaps in Malware-Analysis Sandboxes](https://arxiv.org/abs/2607.14434v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-16
- **作者**: Zhiyong Sui, Lamine Noureddine, Mst Eshita Khatun et al.
- **标签**: `cs.CR` `cs.SE`
- **AI摘要**: 揭示AI环境特征差异以检测恶意软件沙箱
<details>
...
- **评分理由**: 通过实测分析沙箱环境与真实AI环境的特征差异，具有工程实用价值

## Cloud Native Infrastructure

### 1. **[Ground-Side Mission Plan Compilation with Policy-as-Code Guardrails for Cloud-Native Satellite Platforms](https://arxiv.org/abs/2607.14798v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Hsiu-Chi Tsai, Chia-Tung Chung
- **标签**: `cs.DC`
- **AI摘要**: 卫星云原生任务编排与策略合规编译工具链
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对卫星边缘计算的实用工具链，工程实现扎实且可落地。

### 2. **[EdgeFaaS: A Function-based Framework for Edge Computing](https://arxiv.org/abs/2607.14489v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Neha Vadnere, Yu-Ting Wang, Yitao Chen et al.
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出一种异构边缘计算函数虚拟化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统实现完整且在百台设备上进行了真实评估

## Network Stack & Protocol

### 1. **[Scheduler-Agnostic Adaptive-FEC for MPQUIC: Field Evaluation over Commercial Cellular Paths](https://arxiv.org/abs/2607.14482v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Takuma Tsubaki, Soto Anno, Seiya Komatsu et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出一种MPQUIC自适应FEC方案以提升移动网络可靠性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方案实用性强，在真实蜂窝网络环境下进行了充分的实地评估。

### 2. **[Periplus: A Resilient In-band SDN Control Plane via Embedded Forwarding Graphs](https://arxiv.org/abs/2607.14869v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: E. M. Castro Barbero, P. de las Heras Quirós, F. J. Simó Reigadas
- **标签**: `cs.NI`
- **AI摘要**: 基于嵌入式转发图的带内SDN控制平面
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过NSH封装实现快速故障恢复，工程实用性强

### 3. **[Spoofer or Spoofers? Estimating a Lower Bound on the Number of DRDoS Sources Using Anycast Honeypots](https://arxiv.org/abs/2607.14832v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-16
- **作者**: Bernhard Degen, Bas Palinckx, Mattijs Jonker et al.
- **标签**: `cs.NI`
- **AI摘要**: 利用任播蜜罐估算DRDoS攻击源网络数量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于真实全球部署的实证研究，方法论严谨且具工程价值

## Middleware & Runtime

### 1. **[Leaf: An Instrumentation-based Dynamic Analysis Framework for Rust](https://arxiv.org/abs/2607.15025v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Mohammad Omidvar Tehrani, Marco Gaboardi, Nick Sumner et al.
- **标签**: `cs.SE`
- **AI摘要**: Rust动态分析框架，支持运行时语义捕获
<details>
<summary>原始摘要</summary>
