...
### 1. **[CW-Ghost: Search-Free Granularity Selection for Helper-Thread Prefetching via Capacity Windows](https://arxiv.org/abs/2607.25363v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-28
- **作者**: Ya Zhang, Tong Lei, Yao Chen et al.
- **标签**: `cs.DC`
- **AI摘要**: 基于容量窗口的辅助线程预取优化
<details>
...
- **评分理由**: 通过离线分析优化预取粒度，在真实硬件上性能提升显著。

## Container & Virtualization

### 1. **[WASP: A Configurable Framework for Portable Stateful Serverless Applications](https://arxiv.org/abs/2607.25493v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-28
- **作者**: Matteo Cenzato, Dario d'Abate, Arianna Dragoni et al.
- **标签**: `cs.DC` `cs.SE`
- **AI摘要**: WASP实现边缘计算状态化WASM框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解耦设计提升了边缘计算的灵活性与适配性

## eBPF & Observability

### 1. **[Spanergy: Energy-aware Distributed Tracing for Microservices](https://arxiv.org/abs/2607.24902v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-27
- **作者**: César Perdigão Batista, Denis Conan, Sophie Chabridon
- **标签**: `cs.DC` `cs.SE`
- **AI摘要**: 提出Spanergy实现微服务请求级能耗追踪
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过关联追踪与能耗测量，具备实际工程落地价值

## Network Stack & Protocol

### 1. **[MAC-Gyver: Open, Programmable, Scheduling for AI-RAN 6G Systems](https://arxiv.org/abs/2607.26012v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-28
- **作者**: Maxime Elkael, Reshma Prasad, Tamerlan Aghayev et al.
- **标签**: `cs.NI`
- **AI摘要**: MAC-Gyver提供开放式MAC调度框架，支持真实无线环境部署。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了生产级调度器扩展，具备真实硬件与仿真验证，实用性强。

### 2. **[Enhancing Error Detection Performance through Parallel CRC Computation on Multi-Core Architectures](https://arxiv.org/abs/2607.24849v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-25
- **作者**: Mohammad Javad Khani, Mahmood Ahmadi
- **标签**: `cs.DC` `cs.AR`
- **AI摘要**: 基于多核架构的并行CRC计算框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过GF(2)数学变换实现并行CRC，性能提升显著且实用。

## Middleware & Runtime

### 1. **[Right Multiplication on Grammar-Compressed Matrices: A Streaming, Memory-Bounded GPU Engine](https://arxiv.org/abs/2607.24971v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-27
- **作者**: Francesco Tosoni, Gabriele Mencagli
- **标签**: `cs.DS` `cs.DC` `cs.MS`
- **AI摘要**: 基于语法压缩的GPU矩阵乘法引擎
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过SLP压缩实现内存受限下的高效矩阵计算，工程实现扎实。
...
- **AI摘要**: 分析Julia在超大规模HPC场景下的并行性能与扩展性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在6万核规模下验证了Julia的性能，具有工程参考价值

### 3. **[A Fixed-Point Construction of the Elementary Transcendental Functions](https://arxiv.org/abs/2607.23196v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-25
- **作者**: François Alouges, Giovanni Di Fratta, Alberto Fiorenza et al.
- **标签**: `math.CA` `cs.DC` `cs.MS`
- **AI摘要**: 一种基于不动点迭代的超验函数高效计算方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法实现高效且具有实际性能优势，符合系统工程范畴

### 4. **[Characterizing Warp Divergence from Pascal to Blackwell](https://arxiv.org/abs/2607.23402v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-26
- **作者**: Alpin Dale
- **标签**: `cs.AR` `cs.PF`
- **AI摘要**: 揭示NVIDIA GPU架构演进中的分支发散性能特征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过微基准测试量化了GPU分支发散的性能代价与机制演变
...
- **评分理由**: 创新性解决BFT共识尾延迟问题，工程实现详尽

### 2. **[Optimistic Verifiable Claims: A Blockchain Protocol for Conditionally Confidential Bidding in Decentralized Manufacturing](https://arxiv.org/abs/2607.25517v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-07-28
- **作者**: Marko Corn, Nejc Rožman, Primož Podržaj
- **标签**: `cs.CR` `cs.DC` `cs.GT`
- **AI摘要**: 基于区块链的去中心化制造隐私竞标协议
<details>
<summary>原始摘要</summary>
