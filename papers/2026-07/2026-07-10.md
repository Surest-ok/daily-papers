...
### 1. **[Seekable OCI: Lazy-Loading Container Images via Range-Request Indexing](https://arxiv.org/abs/2607.06868v1)**
- **评分**: ⭐ 93/100 | **日期**: 2026-07-07
- **作者**: James Thompson, Wayne Mesard, Jesse Butler et al.
- **标签**: `cs.DC` `cs.OS`
- **AI摘要**: 通过索引实现OCI镜像按需加载，大幅提升容器启动速度
<details>
...
- **评分理由**: 生产环境大规模部署，性能提升显著，工程价值极高

## Network Stack & Protocol

### 1. **[Unveiling TCP BBR Dominance in Starlink Internet: Experimental Insights and Analysis](https://arxiv.org/abs/2607.07133v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Rakshitha De Silva, Shiva Raj Pokhrel, Jonathan Kua
- **标签**: `cs.NI`
- **AI摘要**: 评估BBRv3在星链网络中的拥塞控制性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于全球真实测试床的实测分析，工程参考价值高

## Middleware & Runtime

### 1. **[Finding and Understanding Miscompilation Bugs in the Solidity Compiler](https://arxiv.org/abs/2607.07217v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-08
- **作者**: Bhargava Shastry
- **标签**: `cs.SE` `cs.CR` `cs.PL`
- **AI摘要**: 提出SolSmith工具以发现Solidity编译器漏洞
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过差分模糊测试有效提升了关键基础设施的编译器安全性

## Distributed Systems

### 1. **[Scaling WaterLily.jl with MPI and an improved geometric multigrid solver](https://arxiv.org/abs/2607.07687v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-08
- **作者**: Bernat Font, Marin Lauber, Tzu-Yao Huang et al.
- **标签**: `physics.comp-ph` `cs.DC` `physics.flu-dyn`
- **AI摘要**: 通过MPI与多重网格优化提升流体求解器性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程实现扎实，并行扩展性测试详尽，符合系统工程范畴
