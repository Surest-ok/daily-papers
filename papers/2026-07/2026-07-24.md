...
### 1. **[Black-Box Performance Evaluation of Elastic Block Storage: Contract, Rate-Limiting Model, and Software Exploration](https://arxiv.org/abs/2607.20319v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-22
- **作者**: Yingjia Wang, Ming-Chang Yang
- **标签**: `cs.PF`
- **AI摘要**: 揭示云端块存储特性并优化应用性能
<details>
...
- **评分理由**: 实测数据详实，对云存储性能优化有直接指导意义

## Cloud Native Infrastructure

### 1. **[SequenceFI: Non-intrusive Temporal Fault Injection for Microservice Systems](https://arxiv.org/abs/2607.20050v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-22
- **作者**: Yuzhen Tan, Jian Wang, Bing Li et al.
- **标签**: `cs.SE`
- **AI摘要**: 微服务系统非侵入式时序故障注入框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统实现完善，评估扎实，具备极高的工程实用价值。

### 2. **[Examining QRMI as a Unified Interface for Quantum-HPC Integration](https://arxiv.org/abs/2607.19591v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Thomas Badts, Tim Boyle, Claudio Carvalho et al.
- **标签**: `cs.ET` `cs.DC`
- **AI摘要**: 提出QRMI中间件实现量子计算资源在多调度器下的统一管理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多调度器集成验证了接口的通用性与工程实用价值

## Network Stack & Protocol

### 1. **[SRAN: Scaling Named Data Networking via Map-and-Encap](https://arxiv.org/abs/2607.20363v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-22
- **作者**: Tianyuan Yu, Sirapop Theeranantachai, Lixia Zhang
- **标签**: `cs.NI`
- **AI摘要**: 提出SRAN架构，通过映射封装实现NDN路由扩展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计合理，通过映射解耦提升了NDN的可扩展性。

### 2. **[Scalable Multi-Controller Coordination in Periplus via Border-Switch Forwarding Graphs](https://arxiv.org/abs/2607.19508v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: E. M. Castro Barbero, P. de las Heras Quirós, F. J. Simó Reigadas
- **标签**: `cs.NI`
- **AI摘要**: Periplus实现带内SDN多控制器高效协同
<details>
<summary>原始摘要</summary>
