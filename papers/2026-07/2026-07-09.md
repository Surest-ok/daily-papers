...
### 1. **[Complets: Universal Compartmentalisation and Programming Model For Arm Permission Overlay Extension 2](https://arxiv.org/abs/2607.05569v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-06
- **作者**: Vasily A. Sartakov
- **标签**: `cs.OS` `cs.CR`
- **AI摘要**: 提出Arm POE2架构的通用编程模型与隔离机制
<details>
...
- **评分理由**: 针对硬件特性的系统级抽象，具备实际工程价值

## Container & Virtualization

### 1. **[Bounded-Memory Parallel Image Pulling for Large Container Images](https://arxiv.org/abs/2607.05596v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-06
- **作者**: Sri Saran Balaji Vellore Rajakumar, Henry Wang, Ankur Singh et al.
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: 通过磁盘缓存解决容器镜像拉取内存溢出问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对容器运行时内存瓶颈的工程优化，实测效果显著且易于落地。

## Cloud Native Infrastructure

### 1. **[Bit2Watt: A Cyber-Physical Vulnerability Exploiting GPU Workloads Across Power and Computing Infrastructures](https://arxiv.org/abs/2607.05993v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-07
- **作者**: Zhouhao Ji, Kaikai Pan, Wenyuan Xu
- **标签**: `cs.CR` `cs.AR` `cs.DC`
- **AI摘要**: 利用GPU负载诱发电力基础设施谐波失真的攻击研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨层安全研究新颖，实验验证扎实，但非系统工程优化

### 2. **[Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code](https://arxiv.org/abs/2607.06194v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-07
- **作者**: Audris Mockus
- **标签**: `cs.CR` `cs.SE`
- **AI摘要**: 构建全球代码库提交签名数据集与身份信任分级体系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模数据分析提升代码溯源与身份验证的工程实用性
...
- **评分理由**: 通过协议级实现验证了Unicode隐藏注入风险，工程严谨。

## Middleware & Runtime

### 1. **[Efficient and Robust Lock-Free Multi-Word Compare-and-Swap via Contention-Aware Helping](https://arxiv.org/abs/2607.06034v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Motoki Unno, Kento Sugiura, Yoshiharu Ishikawa
- **标签**: `cs.DB` `cs.DC` `cs.DS`
- **AI摘要**: 提出一种基于竞争感知的无锁MCAS算法以提升并发性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法改进显著且有实机测试，但需在复杂生产环境验证

## Distributed Systems

### 1. **[DDB: Source-Level Interactive Debugging for Distributed Applications](https://arxiv.org/abs/2607.06107v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Yibo Yan, Junzhou He, Seo Jin Park
- **标签**: `cs.DC`
- **AI摘要**: 分布式系统交互式调试器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了分布式调试中的时钟漂移与调用链断裂问题，工程实现扎实。
