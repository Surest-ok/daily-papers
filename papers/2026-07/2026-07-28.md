...
### 1. **[NUMA balancing hampering performance of spiking network simulations](https://arxiv.org/abs/2607.22275v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-24
- **作者**: Melissa Lober, Alp Inangu, Gorka Peraza Coppola et al.
- **标签**: `cs.DC` `q-bio.NC`
- **AI摘要**: 揭示关闭NUMA平衡可显著提升高性能计算能效
<details>
...
- **评分理由**: 通过实测发现NUMA平衡对内存分配的负面影响并提供优化方案

## File Systems & Storage

### 1. **[PRISM: Evaluating POSIX Storage Systems for AI Research Workflows](https://arxiv.org/abs/2607.21746v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Adithya Kumar, Aditya Basu, Jacob Kahn et al.
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: PRISM评估框架用于衡量AI工作流下的POSIX存储性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对AI研究场景的存储评估工具，具备实际部署价值

## Cloud Native Infrastructure

### 1. **[No Edges, No Verdict: A Large-Scale Empirical Study of Declared Dependency Graphs in 78K SBOMs in the Wild](https://arxiv.org/abs/2607.22140v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Artur Zięba-Kozarzewski
- **标签**: `cs.SE` `cs.CR`
- **AI摘要**: 揭示SBOM依赖图缺失问题并提出改进方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模实证研究，对供应链安全有直接工程价值

## Network Stack & Protocol

### 1. **[Fewer Paths, Better Performance: Understanding the ZCube Topology through Braess's Paradox](https://arxiv.org/abs/2607.21893v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-24
- **作者**: Li Chen
- **标签**: `cs.NI`
- **AI摘要**: 提出ZCube拓扑通过减少路径消除拥塞悖论提升性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且有真实生产环境部署数据，工程价值极高

### 2. **[Cleaning the NTP Pool: Detecting and Mitigating NTP-Sourced IPv6 Scanning](https://arxiv.org/abs/2607.21903v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-24
- **作者**: Erik Rye, Robert Beverly
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 提出检测并清理NTP池中恶意IPv6扫描节点的方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实测发现并修复了NTP池的安全漏洞，具有极高工程价值

## Middleware & Runtime

### 1. **[No Snake Oil: Verifying Python Package Builds](https://arxiv.org/abs/2607.21888v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-24
- **作者**: Jens Dietrich, Spencer Sun, Tim W. White et al.
- **标签**: `cs.SE` `cs.CR`
- **AI摘要**: 提出daleq4py工具实现Python包构建等价性验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了供应链安全中构建一致性验证的工程难题

## Distributed Systems

### 1. **[Duet: Co-Optimizing P2P Message Propagation and Rotating-Leader Consensus](https://arxiv.org/abs/2607.22209v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Yifeng Ye, Rongji Huang, Gerui Wang et al.
- **标签**: `cs.DC`
- **AI摘要**: 通过协同P2P网络与共识层提升区块链吞吐量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统设计扎实，在Tendermint上实现并进行了大规模真实云环境验证。

### 2. **[Accountable Transaction Inclusion Lists: Enhancing Ethereum's Censorship Resistance](https://arxiv.org/abs/2607.22040v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-24
- **作者**: Patrick Spiesberger, Hannes Hartenstein
- **标签**: `cs.DC`
- **AI摘要**: 提出FairFIL机制以增强以太坊抗审查能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入可追责的交易包含列表，显著提升了抗审查成本，具备工程落地潜力。
