...
### 1. **[Hardware-Transparent I/O Governance in Disaggregated Heterogeneous Storage](https://arxiv.org/abs/2607.16578v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-07-18
- **作者**: Rajarshi Chowdhury, Akshay Shah, Sue K. Lee
- **标签**: `cs.DC` `cs.OS` `cs.PF`
- **AI摘要**: Oracle Exadata存储I/O治理系统
<details>
...
- **评分理由**: 生产环境部署，解决了异构硬件下的I/O调度难题

## Cloud Native Infrastructure

### 1. **[Cold-Start Model Delivery in Kubernetes Inference Serving: An Empirical Study of OCI-Based Distribution and Its Integrity](https://arxiv.org/abs/2607.16596v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-18
- **作者**: Georgii Kliukovkin
- **标签**: `cs.DC`
- **AI摘要**: 利用OCI镜像机制优化K8s模型加载冷启动
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对K8s模型分发痛点，提供了生产级实现与性能对比

## Network Stack & Protocol

### 1. **[Rethinking Polling Efficiency in Service Core Network Stacks](https://arxiv.org/abs/2607.16408v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Matheus Stolet, Simon Peter, Antoine Kaufmann
- **标签**: `cs.OS` `cs.AR` `cs.NI`
- **AI摘要**: 提出基于功耗预算的网卡核心调度策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入分析硬件功耗限制，对网络栈调度有实际指导意义

## Middleware & Runtime

### 1. **[uSTM: A Lightweight and Efficient STM Supporting General Types and Deferred Aborts](https://arxiv.org/abs/2607.18178v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-20
- **作者**: Zachary Kent, Guy Blelloch, André Costa
- **标签**: `cs.DC`
- **AI摘要**: 轻量级STM实现，支持通用类型与延迟中止
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 代码极简且性能优异，通过新时间戳算法保证了安全性

### 2. **[When to Use Which? Benchmarking Optimisers for Configurable Systems under Varying Budgets](https://arxiv.org/abs/2607.16476v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-17
- **作者**: Chao Jiang, Yulong Ye, Tao Chen et al.
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 系统配置调优器在不同预算下的性能基准评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模实证分析评估了多种调优器，对工程实践有指导意义

## Distributed Systems

### 1. **[Byzantine Fault-Tolerant Post-Quantum Distributed Quorum Signatures](https://arxiv.org/abs/2607.17700v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-20
- **作者**: Quentin Kniep, Jakub Sliwinski, Roger Wattenhofer
- **标签**: `cs.DC`
- **AI摘要**: 提出DQS协议解决后量子共识签名扩展性问题
<details>
<summary>原始摘要</summary>
