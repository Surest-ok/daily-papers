...
### 1. **[Toward a Unified GPU-Aware OpenSHMEM Specification](https://arxiv.org/abs/2607.08006v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-09
- **作者**: Naveen Ravi, Nathan Wichmann, Md. Wasi-ur- Rahman et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出OpenSHMEM GPU感知通信规范以提升跨平台兼容性
<details>
...
- **评分理由**: 针对HPC通信标准化的工程实践，具备良好的实用性与明确的规范定义。
