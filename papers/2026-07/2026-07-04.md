...
### 1. **[FlintKV: A Fast Durable Storage Engine for Modern Databases](https://arxiv.org/abs/2607.02401v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Sergey Egorov, Gregory Chockler, Brijesh Dongol et al.
- **标签**: `cs.DC`
- **AI摘要**: 基于NVM的高性能键值存储引擎
<details>
...
- **评分理由**: 针对NVM优化了并发控制与持久化，具备生产级功能。

### 2. **[SLFS: a Flexible, Low-Cost Distributed File System Using Serverless Designs](https://arxiv.org/abs/2607.01486v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-01
- **作者**: Cheng Hao, Yang, Paola Alsharabaty et al.
- **标签**: `cs.DC`
- **AI摘要**: 基于Serverless的弹性分布式文件系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且评估详实，有效解决了冷启动与成本问题

## Container & Virtualization

### 1. **[Cloak and Detonate: Scanner Evasion and Dynamic Detection of Agent Skill Malware](https://arxiv.org/abs/2607.02357v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Zimo Ji, Congying Xu, Zongjie Li et al.
- **标签**: `cs.CR` `cs.SE`
- **AI摘要**: 提出基于沙箱运行时审计的恶意技能检测系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对AI代理安全，通过运行时行为分析替代静态扫描，工程实用性强。

## eBPF & Observability

### 1. **[GPUAlert: A Zero-Instrumentation Process-Boundary Monitor for Diagnosing GPU Training-Job Failures](https://arxiv.org/abs/2607.01409v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-01
- **作者**: Parv Agarwal, Asif Ekbal
- **标签**: `cs.SE` `cs.AI` `cs.LG`
- **AI摘要**: GPU训练任务零侵入故障监控与诊断工具
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程实用性强，解决了生产环境监控痛点

## Network Stack & Protocol

### 1. **[AB-Sync: Attention-Based Slot-Level Clock Synchronization Method for UWB-TDOA Localization Networks](https://arxiv.org/abs/2606.28087v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-06-26
- **作者**: Tianyi Lyu, Kefei Tian, Kangqiao Qin et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出基于注意力机制的UWB时隙级时钟同步方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对UWB定位系统时钟漂移问题，在真实测试平台验证了有效性。

## Middleware & Runtime

### 1. **[Kani: A Model Checker for Rust](https://arxiv.org/abs/2607.01504v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-01
- **作者**: Rémi Delmas, Zyad Hassan, Qinheping Hu et al.
- **标签**: `cs.SE` `cs.LO` `cs.PL`
- **AI摘要**: Rust语言的开源模型检测工具
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级验证工具，已在生产CI中广泛应用

### 2. **[Elasticity in Parallel Sparse Triangular Solve](https://arxiv.org/abs/2607.02324v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Raphael S. Steiner, Christos K. Matzoros, Pál András Papp et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出弹性并行稀疏三角求解调度器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了高性能调度器，在多核硬件上验证了显著性能提升。

## Distributed Systems

### 1. **[Cadence: Extreme Pipelining with Multiple Concurrent Proposers](https://arxiv.org/abs/2607.02275v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-07-02
- **作者**: Fatima Elsheimy, Mohammad Mussadiq Jalalzai, Tobias Klenze et al.
- **标签**: `cs.DC`
- **AI摘要**: 一种支持多提议者的高性能共识协议
<details>
<summary>原始摘要</summary>
