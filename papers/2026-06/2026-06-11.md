...
### 1. **[The Linux IOCTL Census: A Source-Derived Database of the Linux Kernel Control-Code Surface](https://arxiv.org/abs/2606.10290v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-09
- **作者**: Michael J. Bommarito
- **标签**: `cs.CR` `cs.SE`
- **AI摘要**: 构建Linux内核ioctl接口的自动化审计数据库
<details>
...
- **评分理由**: 通过静态分析构建内核接口审计工具，实用性极高

## Cloud Native Infrastructure

### 1. **[Revisiting "Cooler is Better": ITD-Aware Per-CPU Thermal Optimization for Sustainable Data Center Operation](https://arxiv.org/abs/2606.11163v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-09
- **作者**: Jason Crop, Hayden Moore, Sudeep Pasricha
- **标签**: `cs.DC` `cs.AR`
- **AI摘要**: 利用ITD特性优化数据中心热管理以降低能耗
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于真实生产环境数据，提出了可落地的热管理优化方案。

## Network Stack & Protocol

### 1. **[High-Speed Generation of Periodic Traffic Patterns on P4TG for DDoS and Burst-Load Evaluation](https://arxiv.org/abs/2606.10708v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-09
- **作者**: Fabian Ihle, Etienne Zink, Michael Menth
- **标签**: `cs.NI`
- **AI摘要**: 基于P4的硬件流量生成器，实现高精度周期性流量整形。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在Tofino ASIC上实现了高性能流量整形，实用性强且评估扎实。

### 2. **[Secrets Best Not Shared: DNS Privacy Enhancements for the Constrained IoT](https://arxiv.org/abs/2606.10097v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-06-08
- **作者**: Martine S. Lenders, Thomas C. Schmidt, Matthias Wählisch
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 针对IoT设备的DNS隐私增强协议研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过CoAP协议优化DNS隐私，实测数据详实，工程实用性强。

## Middleware & Runtime

### 1. **[A Hybrid Edge-Cloud Architecture for Low-Latency Entitlement Verification in Resource-Constrained Devices](https://arxiv.org/abs/2606.10536v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-09
- **作者**: Pravin Nagare, Aditya Sabbineni, Devendra Dahiphale et al.
- **标签**: `cs.CR` `cs.AR` `cs.DC`
- **AI摘要**: 提出混合边缘缓存架构降低OTT授权延迟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在实际硬件上实现了低延迟验证，工程实用性高

### 2. **[Hardware-accelerated Aggregation: Unification and Specialization](https://arxiv.org/abs/2606.10030v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-08
- **作者**: Alireza Shateri, Hongshi Tan, Michael Ng et al.
- **标签**: `cs.DC` `cs.DB`
- **AI摘要**: 提出统一硬件加速框架以优化数据聚合性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对异构硬件的聚合优化，实测数据详实且具工程价值

### 3. **[Operationalizing Property-Based Testing for Data-Intensive Scalable Computing Systems](https://arxiv.org/abs/2606.11132v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-09
- **作者**: Yaoxuan Wu, Ingrid Lee, Ahmad Humayun et al.
- **标签**: `cs.SE`
- **AI摘要**: 提出DiscPBT框架用于DISC系统属性测试
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对分布式计算框架的语义测试方案，工程实用性强

## Distributed Systems

### 1. **[GapFuzz: Cross-Plane Divergence Fuzzing for Distributed SDN Controllers](https://arxiv.org/abs/2606.11035v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-09
- **作者**: Moustapha Awwalou Diouf, Samuel Ouya, Jacques Klein et al.
- **标签**: `cs.SE`
- **AI摘要**: 针对SDN控制平面一致性的并发模糊测试工具
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对分布式SDN的跨平面一致性问题，方法严谨且评估充分

### 2. **[Safecloud: A Distributed, Encrypted Storage Cloud for Streaming](https://arxiv.org/abs/2606.09870v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-02
- **作者**: Gregory Magarshak
- **标签**: `cs.CR` `cs.DB` `cs.DC`
- **AI摘要**: 一种基于密钥派生的分布式加密存储与流媒体系统
<details>
<summary>原始摘要</summary>
