...
### 1. **[Needles at Scale: LLM-Assisted Target Selection for Windows Vulnerability Research](https://arxiv.org/abs/2606.01364v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-31
- **作者**: Michael J. Bommarito
- **标签**: `cs.CR` `cs.AI` `cs.SE`
- **AI摘要**: 利用LLM实现Windows漏洞目标自动化筛选
<details>
...
- **评分理由**: 系统级漏洞挖掘的创新流水线，实用性与严谨性兼备。

### 2. **[A Secure, Manifest-Based Framework for Delegated Privilege Promotion](https://arxiv.org/abs/2605.28991v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-27
- **作者**: Rajarshi Chowdhury, Akshay Shah
- **标签**: `cs.CR` `cs.OS`
- **AI摘要**: 基于清单的特权提升与安全更新框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了系统维护中特权管理的安全性与自动化问题

## Distributed Systems

### 1. **[Scaling LLM Inference Beyond Amdahl`s Limits via Eliminating Non-Scalable Overheads](https://arxiv.org/abs/2606.01927v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Alan Zhao, Cyril Y. He, Wei Xu
- **标签**: `cs.DC`
- **AI摘要**: Albireo通过优化并行调度提升LLM推理性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统级优化显著提升了大模型推理的吞吐与效率

### 2. **[Don't Let a Few Network Failures Slow the Entire AllReduce](https://arxiv.org/abs/2606.01680v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Peiqing Chen, Jiedong Jiang, Nengneng Yu et al.
- **标签**: `cs.DC` `cs.LG` `cs.NI`
- **AI摘要**: 提出OptCC算法优化故障下的AllReduce通信性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对GPU集群网络故障的通信优化，理论与实验扎实

### 3. **[Lodestar: An Online-Learning LLM Inference Router](https://arxiv.org/abs/2606.00946v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-31
- **作者**: Gangmuk Lim, Wanyu Zhao, Brighten Godfrey et al.
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 基于在线学习的LLM推理路由系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对分布式GPU集群的路由优化，创新性强且实用价值高。

### 4. **[Characterizing Metastable Faults and Failures](https://arxiv.org/abs/2606.00942v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-31
- **作者**: Ali Farahbakhsh, Qingjie Lu, Lorenzo Alvisi et al.
- **标签**: `cs.OS` `cs.DC`
- **AI摘要**: 提出亚稳态故障的因果表征与容错方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入揭示分布式系统亚稳态故障机制，具有极高学术与工程价值。

### 5. **[ViBE: Co-Optimizing Workload Skew and Hardware Variability for MoE Serving](https://arxiv.org/abs/2606.00735v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-30
- **作者**: Seokjin Go, Marko Scrbak, Ephrem Wu et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 提出ViBE框架优化MoE推理负载均衡
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对分布式GPU异构性优化专家放置，显著提升推理效率。

## Container & Virtualization

### 1. **[Formal Verification of Secure Encrypted Virtualization](https://arxiv.org/abs/2606.01381v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-31
- **作者**: Hansika Weerasena, Amitabh Das, Prabhat Mishra
- **标签**: `cs.CR` `cs.AR`
- **AI摘要**: 提出AMD SEV形式化验证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对机密计算的安全性提供了严谨的形式化验证方法

## Cloud Native

### 1. **[Observation, Not Prediction: Conversation-Level Disaggregated Scheduling for Agentic Serving](https://arxiv.org/abs/2606.01839v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Jianru Ding, Ryien Hosseini, Pouya Mahdi Gholami et al.
...
- **评分理由**: 通过改变调度粒度消除预测依赖，显著提升系统效率

### 2. **[Offloading L7 Policies to the Kernel](https://arxiv.org/abs/2605.31084v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-29
- **作者**: Laurin Brandner, Ayush Mishra, Sebastiano Miano et al.
- **标签**: `cs.NI`
- **AI摘要**: 通过eBPF将L7策略卸载至内核以加速服务网格
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用eBPF显著降低服务网格上下文切换开销，性能提升显著

### 3. **[RTP-LLM: High-Performance Alibaba LLM Inference Engine](https://arxiv.org/abs/2605.29639v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-28
- **作者**: Boyu Tan, Jiarui Guo, Zongwei Lv et al.
- **标签**: `cs.OS`
- **AI摘要**: 高性能LLM推理引擎，优化调度与缓存机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级落地验证，系统架构优化显著提升推理效率。

### 4. **[Fail-Closed Lowering of Resident KV Claims onto LLM Serving Runtimes](https://arxiv.org/abs/2606.01387v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-31
- **作者**: Lukas Stepanek
- **标签**: `cs.DC`
- **AI摘要**: 提出KV缓存驻留声明的失败关闭映射机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对LLM推理运行时KV缓存管理的系统级形式化验证，具有较强创新性。

### 5. **[Kairos: Lightweight Testing Framework for Timing-Induced Interaction Failures in LTE and 5G Core Networks](https://arxiv.org/abs/2605.30985v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-29
- **作者**: Wei Guo, Yuanhao Li, Hao Zheng et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出Kairos框架检测5G核心网时序交互故障
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对云原生核心网时序故障的测试方案，具有较强系统实用性。

## Linux Kernel & System Development

### 1. **[Beyond Edge Coverage: Per-Task Data-Flow Extraction at Kernel Function Boundaries via LLVM](https://arxiv.org/abs/2606.00455v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-30
- **作者**: Yunseong Kim
- **标签**: `cs.CR` `cs.OS`
- **AI摘要**: 基于LLVM的内核数据流提取框架，提升模糊测试效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对内核模糊测试的反馈机制创新，实用性与严谨性俱佳。

### 2. **[Waiting at the front door: Continuous monitoring of latency in the host network stack](https://arxiv.org/abs/2606.02057v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Simon Sundberg, Anna Brunstrom, Simone Ferlin-Reiter et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出一种低开销主机网络栈延迟监控工具
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对内核网络栈延迟的监控方案具有高实用性与严谨性

## Graphics & GPU Systems

### 1. **[Parallelizing Large-Scale Tensor Network Contraction on Multiple GPUs](https://arxiv.org/abs/2606.01852v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Feng Pan, Hanfeng Gu, Paul Springer et al.
- **标签**: `cs.DC` `quant-ph`
- **AI摘要**: 多GPU张量收缩的通信优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在多GPU系统上实现了极高的通信效率与扩展性

### 2. **[Move the Query, Not the Cache: Characterizing Cross-Instance Latent Attention Redistribution Across GPU Fabrics](https://arxiv.org/abs/2606.01502v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-31
- **作者**: Bole Ma, Jan Eitzinger, Harald Köstler et al.
- **标签**: `cs.DC` `cs.AI` `cs.NI`
- **AI摘要**: 提出跨节点MLA查询路由机制以优化GPU集群注意力计算
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对大模型分布式推理的通信优化，方法严谨且实用性极高。

### 3. **[Regular-Dead on Arrival: Characterizing and Protecting Against Dead-Entry TLB Misses in GPU Microarchitectures](https://arxiv.org/abs/2606.00486v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-30
- **作者**: Shafayat Mowla Anik, Yongchan Jung, Jeeho Ryoo et al.
- **标签**: `cs.AR` `cs.PF`
- **AI摘要**: 提出DEPOT机制缓解GPU页表缓存失效问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对GPU TLB性能瓶颈提出创新架构方案，实验详实且提升显著。

### 4. **[Memory-Bound but Not Bandwidth-Limited: The Physical AI Inference Gap in Batch-1 LLM Decode](https://arxiv.org/abs/2605.30571v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-28
- **作者**: Josef Chen
- **标签**: `cs.AR` `cs.AI` `cs.DC`
- **AI摘要**: 揭示批处理1下LLM推理的启动开销瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入分析GPU架构与推理延迟，对系统优化极具价值

### 5. **[From Roofline to Ruggedness: Decomposing and Smoothing the GEMM Performance Landscape](https://arxiv.org/abs/2605.29752v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-28
- **作者**: Aditya Chatterjee
- **标签**: `cs.PF` `cs.AR` `cs.DC`
- **AI摘要**: 提出性能崎岖度分析框架以优化GEMM算子
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分解性能波动来源并优化调度，显著提升了GPU算子性能。

## System Architecture

### 1. **[CHIMERA: A Flexible and Scalable 3.1 TOPS/W AI-MCU with Transformer Accelerator and 563 Gb/s Shared-L2 Memory Subsystem with QoS Guarantees](https://arxiv.org/abs/2606.02358v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Lorenzo Leone, Philip Wiese, Gamze İslamoğlu et al.
- **标签**: `cs.AR`
- **AI摘要**: 高性能Transformer加速器与L2内存子系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著，内存子系统QoS设计在边缘计算中极具价值

### 2. **[Leyline: KV Cache Directives for Agentic Inference](https://arxiv.org/abs/2606.01065v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-31
- **作者**: Bole Ma, Jan Eitzinger, Harald Koestler
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 提出Leyline原语优化Agent KV缓存编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对Agent推理的KV缓存管理创新，系统架构贡献显著

### 3. **[IORM: Hierarchical I/O Governance for Thousands of Consolidated Databases on Oracle Exadata](https://arxiv.org/abs/2605.29006v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-27
- **作者**: Rajarshi Chowdhury, Akshay Shah, Zakaria Alrmaih et al.
- **标签**: `cs.DB` `cs.DC` `cs.OS`
- **AI摘要**: 提出IORM实现多租户数据库存储资源分层治理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了大规模数据库整合下的I/O干扰与资源调度难题，工业界实践价值极高。

### 4. **[O-POPE: High-Frequency Pipelined Outer Product based GEMM acceleration with minimal buffering overhead](https://arxiv.org/abs/2606.02333v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Danilo Cammarata, Angelo Garofalo, Luca Benini
- **标签**: `cs.AR`
- **AI摘要**: 提出O-POPE架构优化GEMM加速器性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过复用FPU流水线寄存器提升计算效率，架构设计创新且实用。

### 5. **[SparseX: Efficient Segment-Level KV Cache Sharing for Interleaved LLM Serving](https://arxiv.org/abs/2606.01751v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Quqing Zhang, Kai Chen, Ning Liao et al.
- **标签**: `cs.PF`
- **AI摘要**: 提出SparseX实现高效KV缓存共享
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对LLM推理的缓存机制优化，系统架构设计扎实且实用。
