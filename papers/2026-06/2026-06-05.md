...
### 1. **[Throughput-Optimal Multiresource-Job Scheduling with Continuous Requirement Distribution](https://arxiv.org/abs/2605.21715v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Heyuan Yao, Willow Kowalik, Izzy Grosof
- **标签**: `cs.PF`
- **AI摘要**: 提出连续资源需求下的最优调度策略
<details>
...
- **评分理由**: 理论创新性强，解决了多资源调度中的连续分布难题

### 2. **[$γ$-CounterBoost: Optimizing response time tails using job type information only](https://arxiv.org/abs/2606.02311v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: Nils Charlet, Benny Van Houdt
- **标签**: `cs.PF` `math.PR`
- **AI摘要**: 提出γ-CounterBoost调度策略以优化响应时间尾部延迟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，解决了多类型任务调度下的尾部延迟优化问题

### 3. **[Attributing the System's Overall Effect to its Components](https://arxiv.org/abs/2605.26643v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-26
- **作者**: Chenxi Wang, Lei Wang, Wanling Gao et al.
- **标签**: `cs.PF`
- **AI摘要**: 提出一种系统组件性能贡献度量化评估方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了复杂系统组件性能隔离与归因的难题

### 4. **[HammerSim: A System-Level Tool to Model RowHammer](https://arxiv.org/abs/2605.27803v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-27
- **作者**: Kaustav Goswami, Ayaz Akram, Hari Venugopalan et al.
- **标签**: `cs.CR` `cs.AR`
- **AI摘要**: 基于gem5的RowHammer系统级建模仿真框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了系统级RowHammer仿真工具的空白，验证严谨且实用性强。

### 5. **[Experimentation for Different Scheduling Policies on Queues: Mixed Differences-in-Q Estimators Based on Little's Law](https://arxiv.org/abs/2605.29641v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-28
- **作者**: Nanshan Jia, Ramesh Johari, Nian Si et al.
- **标签**: `stat.ME` `cs.PF` `math.PR`
- **AI摘要**: 提出混合差分队列估计器以优化调度算法的A/B测试。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Little定律改进调度测试，方法严谨且具实用价值。

## File Systems & Storage

### 1. **[GNStor: Design of GPU-Native High-Performance Remote All-Flash Array](https://arxiv.org/abs/2606.04908v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-03
- **作者**: Shushu Yi, Wenbo Wu, Guoci Chen et al.
- **标签**: `cs.OS`
- **AI摘要**: GNStor实现GPU直连远程全闪存阵列
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出GPU原生存储栈，显著提升IO性能

### 2. **[ACEAPEX: Parallel LZ77 Decoding via Encode-Time Absolute Offset Resolution](https://arxiv.org/abs/2606.04268v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-02
- **作者**: Yakiv Shavidze
- **标签**: `cs.DC`
- **AI摘要**: 提出一种基于绝对偏移的并行LZ77解码方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过绝对偏移解析实现高效并行解码，性能提升显著

## Cloud Native & Orchestration

### 1. **[COSMO: O-RAN-Based Service Management and Orchestration for Cross-Technology Multi-Tenant Radio Access Networks](https://arxiv.org/abs/2606.05012v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-03
- **作者**: M. Catalan-Cid, J. J. Aleixendri, J. Pueyo et al.
- **标签**: `cs.NI`
- **AI摘要**: 提出COSMO架构实现异构RAN多租户编排与资源管理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对O-RAN架构的跨技术资源管理，设计严谨且实用性强

## Networking & Protocol

### 1. **[RAMC: Remote Access Memory Channels over HPE Slingshot](https://arxiv.org/abs/2606.05094v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-03
- **作者**: Whit Schonbein, Matthew G. F. Dosanjh, Scott Levy
- **标签**: `cs.NI`
- **AI摘要**: 提出RAMC通信库优化Slingshot网络性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对高性能网络通信的创新设计，实验数据扎实且性能提升显著。

### 2. **[Anycast Performance in Context](https://arxiv.org/abs/2606.04298v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-02
- **作者**: Eric Liang
- **标签**: `cs.NI` `cs.AI`
- **AI摘要**: 对比分析DNS与CDN的任播性能差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入剖析任播路由机制，对基础设施优化有指导意义

### 3. **[Bridging High-Level Intent and Network Execution: Detecting Violations and Intent Drift Through Low-Level Traffic Analysis](https://arxiv.org/abs/2606.05076v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-03
- **作者**: Tonia Haikal, Shereen Ismail, Eman Hammad
- **标签**: `cs.NI`
- **AI摘要**: 通过低级流量分析检测网络意图漂移与违规
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，对网络意图验证有实际贡献

### 4. **[FlexLink: Decoupling Control and Data Beams for Next-Generation Wideband Networks](https://arxiv.org/abs/2606.01454v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-31
- **作者**: Ish Kumar Jain, Rohith Reddy Vennam, Dinesh Bharadia
- **标签**: `eess.SP` `cs.NI`
- **AI摘要**: 提出延迟相控阵架构以解耦控制与数据波束
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 硬件原型验证充分，在网络物理层有显著创新

### 5. **[MeshGuard: MUD-Based Network Access Control for Large-Scale Thread-Powered IoT Networks](https://arxiv.org/abs/2605.31326v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-29
- **作者**: Dominik Roy George, Wouter van Hoof, Habib Mostafaei et al.
- **标签**: `cs.CR` `cs.NI`
- **AI摘要**: 提出MeshGuard实现Thread网络MUD访问控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了Thread网络中MUD扩展性与多边界路由同步问题

## Distributed Systems & Consensus

### 1. **[Clownfish: Scaling DAG-based BFT Consensus via Sparse Edges](https://arxiv.org/abs/2606.04687v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-03
- **作者**: Feifan Wang, Jingfan Yu, Zixi Cai et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出Clownfish协议以优化DAG共识通信复杂度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过稀疏边设计提升了DAG共识的可扩展性，方法严谨

## Real-Time & Embedded Systems

### 1. **[Implementation and Optimization of HQC Decoding on NPU-Integrated Devices](https://arxiv.org/abs/2606.01968v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: Vu Minh Chau, Nguyen Ngoc Kiet, Pham Quang Minh et al.
- **标签**: `cs.CR` `cs.AR` `cs.PF`
- **AI摘要**: 利用HVX向量化优化HQC解码性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对嵌入式NPU架构的密码学算法优化，方法严谨且实用性强。

### 2. **[TAPAAL SMC: Statistical Model Checking of Stochastic Timed-Arc Petri Nets](https://arxiv.org/abs/2606.02007v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-01
- **作者**: Tanguy Dubois, Kim G. Larsen, Jiri Srba
- **标签**: `cs.DC`
- **AI摘要**: 提出随机时间弧Petri网的统计模型检测算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 形式化验证方法严谨，对实时系统建模有实用价值

## Graphics & Display Systems

### 1. **[Graph Traversal on Tensor Cores: A BFS Framework for Modern GPUs](https://arxiv.org/abs/2606.05081v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-03
- **作者**: Deniz Elbek, Kamer Kaya
- **标签**: `cs.DC` `cs.DS`
- **AI摘要**: 利用Tensor Cores加速图遍历的框架
<details>
<summary>原始摘要</summary>
