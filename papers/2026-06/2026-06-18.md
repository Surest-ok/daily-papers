...
### 1. **[Security-Induced Braess Paradoxes in Service Function Chain Orchestration](https://arxiv.org/abs/2606.17987v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: Daniel Commey, Bin Mai
- **标签**: `cs.NI` `cs.CR` `cs.GT`
- **AI摘要**: 揭示SFC编排中的Braess悖论并提出缓解策略
<details>
...
- **评分理由**: 通过实验验证了安全编排中的负载均衡问题，实用性强

## Network Stack & Protocol

### 1. **[DPDS: A DPDK-Based Packet Delayer and Spacer](https://arxiv.org/abs/2606.17716v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-16
- **作者**: Etienne Zink, Fabian Ihle, Michael Menth
- **标签**: `cs.NI`
- **AI摘要**: 基于DPDK的高性能网络链路仿真器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现高效且高吞吐的链路延迟仿真，性能优于现有方案

### 2. **[The Multipath Reliable Connection (MRC) Transport](https://arxiv.org/abs/2606.18170v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: Rip Sohan, Eric Spada, Eric Davis et al.
- **标签**: `cs.NI`
- **AI摘要**: 一种基于RoCEv2的生产级多路径传输协议
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对数据中心网络优化的传输协议，具备生产级部署潜力。

### 3. **[5G Network Architecture and Configuration Choices to Support Teleoperated Driving at Scale](https://arxiv.org/abs/2606.17654v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-06-16
- **作者**: M. C. Lucas-Estañ, B. Coll-Perales, M. I. Khan et al.
- **标签**: `cs.NI`
- **AI摘要**: 评估5G边缘网络对远程驾驶的扩展性支持
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对5G架构的实证研究，对远程驾驶部署有指导意义

## Middleware & Runtime

### 1. **[Group Commit Self-Clocks: Why Tuning Is Unnecessary Above a Device-Set Load Threshold](https://arxiv.org/abs/2606.18187v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-16
- **作者**: Madhulatha Mandarapu, Sandeep Kunkunuru
- **标签**: `cs.DB` `cs.PF`
- **AI摘要**: 证明数据库提交延迟调优在负载阈值后失效
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过闭环排队论解释了生产实践，实验扎实且具指导意义

### 2. **[Space-Efficient Lock-Free Linear-Probing Hash Table](https://arxiv.org/abs/2606.17315v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Hagit Attiya, Rotem Oshman, Noa Schiller
- **标签**: `cs.DC` `cs.DS`
- **AI摘要**: 一种高效无锁线性探测哈希表
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法设计精巧且实用，兼顾空间效率与并发性能

### 3. **[Verifying the Rust Standard Library](https://arxiv.org/abs/2606.17374v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-16
- **作者**: Byron Cook, Remi Delmas, Zyad Hassan et al.
- **标签**: `cs.LO` `cs.PL` `cs.SE`
- **AI摘要**: 通过众包形式对Rust标准库进行形式化验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 验证工作严谨且具有极高工程价值，但非系统架构创新

## Distributed Systems

### 1. **[Fractional Verkle Trees: A Hypertree Decomposition and Verified Proof Serialization Architecture for High-Performance Blockchain State Accumulators](https://arxiv.org/abs/2606.17111v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Ekleen Kaur, Everton Fraga
- **标签**: `cs.CR` `cs.DC` `cs.PF`
- **AI摘要**: 提出分式Verkle树优化区块链状态存储
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对性解决存储瓶颈，实测性能提升显著且可落地

### 2. **[Gatling: Rapid-Fire Consensus from Parallel Composition](https://arxiv.org/abs/2606.18220v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: Giulia Scaffino, Max Resnick, Joachim Neu
- **标签**: `cs.CR` `cs.DC`
- **AI摘要**: 通过并行组合共识实例实现更低提案间隔
<details>
<summary>原始摘要</summary>
