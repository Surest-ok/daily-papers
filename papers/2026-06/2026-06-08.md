...
### 1. **[Tutti: Making SSD-Backed KV Cache Practical for Long-Context LLM Serving](https://arxiv.org/abs/2605.03375v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-05
- **作者**: Shi Qiu, Yifan Hu, Xintao Wang et al.
- **标签**: `cs.OS`
- **AI摘要**: Tutti：面向长上下文LLM推理的SSD KV缓存方案
<details>
...
- **评分理由**: 新颖的GPU存储栈和IO调度，解决了SSD KV缓存性能瓶颈，有实际系统实现和评估，但核心是LLM服务优化，非纯系统研究。

### 2. **[Virtual-Memory Powersort](https://arxiv.org/abs/2605.27147v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-26
- **作者**: Finn Moltmann, Tamio-Vesa Nakajima, Sebastian Wild
- **标签**: `cs.DS` `cs.PF`
- **AI摘要**: 一种低内存占用的自适应归并排序算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法优化显著，且有实证评估，实用性较强

### 3. **[A Virtual Processor brings back the Free Lunch](https://arxiv.org/abs/2605.30507v2)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-28
- **作者**: Haymo Kutschbach
- **标签**: `cs.PF` `cs.DC` `cs.PL`
- **AI摘要**: 一种去中心化的自优化虚拟处理器架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过运行时依赖分析实现自动并行化，具备工程实现。

### 4. **[ACALSim: A Scalable Parallel Simulation Framework for High-Performance System Design Space Exploration](https://arxiv.org/abs/2605.22936v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-21
- **作者**: Wei-Fen Lin, Jen-Chien Chang, Yen-Po Chen et al.
- **标签**: `cs.AR` `cs.PF`
- **AI摘要**: 一种高性能并行架构仿真框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构仿真工具，具备良好的性能评估与实现，但非生产基础设施。
