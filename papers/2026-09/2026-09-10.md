...
### 1. **[Sharing a Fabric with Collective Communication: Two Storage Penalties in Deep Learning Training](https://arxiv.org/abs/2609.06506v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-06
- **作者**: Chen Wang, Wenzhao Wu, Hyojin Kim et al.
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: 通过本地NVMe缓存解决分布式训练存储I/O与通信冲突
<details>
...
- **评分理由**: 针对HPC存储瓶颈提出实用的缓存方案，实验扎实且代码开源。

## Cloud Native Infrastructure

### 1. **[WAPP: Safe Learning of Positive Security WAF Policies from Live Traffic](https://arxiv.org/abs/2609.06840v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-06
- **作者**: Heba Osama, Zeyad Ahmed, Mohamed Amgad et al.
- **标签**: `cs.CR` `cs.AI` `cs.NI`
- **AI摘要**: 一种基于流量学习的WAF安全策略自动生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统实现完整，评估扎实，解决了WAF策略维护难题

## Network Stack & Protocol

### 1. **[Real-Time dApps for AI-RAN: Measured Interface Requirements for Inline PHY and Slot-Level Control](https://arxiv.org/abs/2609.07805v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-07
- **作者**: Timothy O'Shea, Matthew Pennybacker, Andriy Kharchenko
- **标签**: `cs.NI` `cs.DC` `eess.SP`
- **AI摘要**: AI-RAN分布式应用接口设计与性能评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对5G DU的实时控制接口进行了实测与优化，工程价值高。

### 2. **[6SEVEN: System for EValuating IPv6 ENumeration algorithms](https://arxiv.org/abs/2609.08098v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-08
- **作者**: Chase Kanipe, Erik Rye, Dave Levin et al.
- **标签**: `cs.NI`
- **AI摘要**: 构建IPv6地址枚举算法评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提供统一评估工具，提升网络测量科学性与可比性

### 3. **[The OCUDU dApp Platform: An Open Runtime and E3 Interface for Real-Time AI-RAN](https://arxiv.org/abs/2609.07843v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-07
- **作者**: Timothy O'Shea, Matthew Pennybacker, Andriy Kharchenko
- **标签**: `cs.NI` `cs.LG` `eess.SP`
- **AI摘要**: OCUDU提供AI-RAN实时运行环境与E3接口
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了5G DU内AI应用的实时调度与部署，工程实践扎实。

### 4. **[The LQ Digital Mode Family: Protocol Architecture and Reference Specification for Weak-Signal Communications](https://arxiv.org/abs/2609.06427v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-06
- **作者**: Luis Quesada
- **标签**: `cs.NI` `cs.IT` `eess.SP`
- **AI摘要**: LQ8协议通过变长编码优化业余无线电通信效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 协议设计实用且具备明确的性能提升，符合通信协议范畴

### 5. **[Exploring the Initial Performance of NB-IoT NTN over GEO: Measurement and Analysis](https://arxiv.org/abs/2609.06280v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-05
- **作者**: Xiong Wang, Yumin Du, Bin Gu et al.
- **标签**: `cs.NI`
- **AI摘要**: NB-IoT NTN性能实测与优化分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于真实卫星网络测试，评估延迟与能耗并提出优化方案

## Middleware & Runtime

### 1. **[DejaVu: Unifying Memory Allocations to Eliminate Redundant Copies on Unified-Memory SoCs](https://arxiv.org/abs/2609.05635v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-04
- **作者**: Yuheng Zhu, Yanbo Zhao, Jiajia Li et al.
- **标签**: `cs.DC` `cs.OS`
- **AI摘要**: 消除UMA架构下冗余内存拷贝的优化系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对实际硬件的优化，有真实性能提升与部署价值

### 2. **[TreeRedux: Separating Concerns in Spark's Distributed Tree Aggregation](https://arxiv.org/abs/2609.06982v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-07
- **作者**: David A. G. Harrison, Ivan Cao
- **标签**: `cs.DC`
- **AI摘要**: 优化Spark聚合，降低驱动节点内存压力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对分布式计算瓶颈提出实用改进，实验数据详实。

### 3. **[Interactive Debugger for Performance Portable Python HPC Kernels](https://arxiv.org/abs/2609.07912v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-07
- **作者**: Ivan Grigorik, Gabriel Kosmacher, George Biros et al.
- **标签**: `cs.DC`
- **AI摘要**: PKDB实现Python HPC内核的交互式调试与热重载
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了跨设备调试痛点，具备实际工程价值与评估

### 4. **[ForgeStencil: Automating Per-Case Stencil Specialization from Kernels to 100+ Real Applications](https://arxiv.org/abs/2609.06694v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-06
- **作者**: Yaojian Chen, Yuxuan Li, Wubing Wan et al.
- **标签**: `cs.DC`
- **AI摘要**: 自动化生成GPU模板算子与应用重构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过代码合成实现算子特化，在百余个工业应用中实测性能提升显著

### 5. **[EventSpec: Defining and Detecting Event-Semantic Issues in Blockchain Ecosystems](https://arxiv.org/abs/2609.07865v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-07
- **作者**: Yixuan Liu, Yuxin Dong, Ye Liu et al.
- **标签**: `cs.CR` `cs.SE`
- **AI摘要**: 提出EventSpec检测智能合约事件语义缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对区块链事件语义一致性问题，有实测与漏洞发现，工程实用性强。

## Distributed Systems

### 1. **[From Bracha to Coded MBRB: Benchmarking Byzantine Reliable Broadcast Implementations](https://arxiv.org/abs/2609.07521v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-07
- **作者**: Yenan Wang, Jesper Kullberg, Fabian Paglianno Persson et al.
- **标签**: `cs.DC`
- **AI摘要**: 实现并基准测试了多种拜占庭可靠广播算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多环境大规模实测揭示了算法的工程性能权衡

### 2. **[Distributed Linear Programming on GPU Clusters at Extreme Scale](https://arxiv.org/abs/2609.09108v1)**
...
- **评分理由**: 实现了大规模分布式线性规划，性能提升显著且评估扎实。

### 3. **[GraphFAS: A Distributed System for Automated Graph Feature Generation and Selection in Industrial Transaction Networks](https://arxiv.org/abs/2609.08970v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-08
- **作者**: Yice Luo, Yun Zhu, Xi Chen et al.
- **标签**: `cs.LG` `cs.AI` `cs.DC`
- **AI摘要**: 分布式图特征生成与自动化选择系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级部署验证，工程效率提升显著，实用性强。

### 4. **[Diamond Agent: Agentic Control of Federated HPC Resources as a Service](https://arxiv.org/abs/2609.06181v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-05
- **作者**: Haotian Xie, Junlin Chen, Mingkai Zheng et al.
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 跨异构HPC集群的智能任务编排系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对HPC资源调度提出实用代理架构，实验评估扎实。

### 5. **[Service Health Engineering for Distributed Systems](https://arxiv.org/abs/2609.08020v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-07
- **作者**: Siva Rama Krishna Varma Bayyavarapu
- **标签**: `cs.SE`
- **AI摘要**: 提出以用户旅程为核心的分布式系统健康度量工程实践
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将可靠性工程实践与业务流程结合，具有极高的工程落地价值
